...
public class CentroTO {
	...
	public CentroTO(CentroCustoEntity centro) {
		this.id = centro.getId();
		this.nome = centro.getNome();
		this.status = centro.getStatus().toString();
		this.removed = centro.getRemovido();
		this.dataRemovido = centro.getDataRemovido();
	}
